    ...
    <div class = "container h-100">
        ...
        <div class = "d-flex mb-3">
            ...
            <a href = "#" class = "ms-4 link-dark text-decoration-none" data-bs-toggle = "modal" data-bs-target = "#addTagModal">
                <div class = "d-flex align-items-center">
                    <span class = "fs-5 fw-blod">+</span>&nbsp;タグの追加
                </div>
            </a>
        </div>
                ...
                <div class = "col">
                    <div class = "card bg-light">
                        <div class = "card-body d-flex justify-content-between align-items-center">
                            ...
                            <div class = "d-flex align-items-center">
                                ...
                                <div class = "dropdown">
                                    ...
                                    <ul class = "dropdown-menu dropdown-menup-end text-center" aria-labelledby = "dropdownGoalMenuLink">
                        ...
                        @foreach ($goal->todos()->orderBy('done', 'asc')->get() as $todo)
                            <!-- ToDoの編集用モーダル -->
                            @include('modal.edit_todo')

                            <!-- ToDoの削除用モーダル -->
                            @include('modal.delete_todo')
                                    ...
                                    <div class = "d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <div class = "dropdown">
                                            ...
                                            <ul class = "dropdown-menu dropdown-menu-end text-center" aria-labelledby = "dropdownTodoMenuLink">
                                                <li>
                                                    <form action = "{{ route('goals.todo.update', [$goal, $todo]) }}" method = "post">
                                                        @csrf
                                                        @method('patch')
                                                        <input type = "hidden" name = "content" value = "{{ $todo->content }}">
                                                        @if($todo->done)
                                                           <input type = "hidden" name = "done" value = "false">
                                                           <button type = "submit" class = "dropdown-itme btn btn-link">未完了</button>
                                                        @else
